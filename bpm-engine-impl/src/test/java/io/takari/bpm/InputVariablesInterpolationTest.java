...
public class InputVariablesInterpolationTest extends AbstractEngineTest {
    ...
    public void test() throws Exception {
        ...
        String varValue = "${testBean.getValue()}";
        String beanValue = "val_" + System.currentTimeMillis();
